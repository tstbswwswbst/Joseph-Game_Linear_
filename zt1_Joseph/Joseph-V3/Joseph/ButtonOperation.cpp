...
// 初始化按钮
void ButtonOperation::initButtons(int button_num, int layer) {
...
// 绘制所有按钮
void ButtonOperation::drawButtons() {
...
// 处理按钮点击事件
int ButtonOperation::handleButtonClick(int mouseX, int mouseY, vector<Button>& buttons, int layer, AccountSystem& account_system, AccountOperation& account_operation, JosephGame& Joseph_game, int& flag) {
    int i = 0;
    flag = 0;
